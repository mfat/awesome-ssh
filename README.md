...
* [SSH Pilot](https://github.com/mfat/sshpilot) [![stars](https://img.shields.io/github/stars/mfat/sshpilot?style=social)](https://github.com/mfat/sshpilot) - Graphical SSH connection manager with a built-in terminal and SFTP file manager.
